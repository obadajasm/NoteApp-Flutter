...
import "package:testapp/screens/note_detailed.dart";
import 'dart:async';
        ...
        return Card(
          ...
          child: ListTile(
            leading: CircleAvatar(
              backgroundColor:
                  getPriorityColor(this.noteList[postion].priority),
              child: getPriorityIcon(this.noteList[postion].priority),
            ),
            title: Text(this.noteList[postion].title),
            ...
            onTap: () {
              debugPrint("listTilte Tapped");
              navigateToDetail(this.noteList[postion], 'Edit Note');
            },
          ),
        );
      },
